...
class SupportTicketRecord(UsersBase):
    ...
    # user_id is nullable so logged-out visitors can still contact you
    user_id = Column(UUID(as_uuid=True), ForeignKey("platform_users.user_id", ondelete="SET NULL"), nullable=True, index=True)
