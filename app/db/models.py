...
class PostBookmarkRecord(PostsBase):
    """Tracks which user bookmarked which post.
    Bookmark state is queried from this table directly — no counter column."""
    ...
    __table_args__ = (
        UniqueConstraint("post_id", "user_id", name="uq_post_bookmarks_post_user"),
    )
